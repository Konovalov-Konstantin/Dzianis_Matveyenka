...
public class EntityListener {
    ...
    @EventListener(condition = "#root.args[0].accessType != 'CREATE'")    // условия фильтрации, на какие события будет срабатывать данный listener (этот listener получит событие, если у первого аргумента метода (args[0] - entityEvent) accessType будет не 'CREATE')
